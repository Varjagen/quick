...
function MapCanvas({
  ...
  }, Math.round(moveMarker.remFt), " ft", moveMarker.mode === 'fly' ? ' · fly' : moveMarker.mode === 'jump' ? ' · jump' : moveMarker.dashed ? ' · dash' : ''))), visibleTokens.map(t => {
    const ent = entities[t.entityId];
    if (!ent) return null;
...
function EntityForm({
  ...
  })), /*#__PURE__*/React.createElement("div", null)), isHpType && /*#__PURE__*/React.createElement("div", {
    className: "form-row-3"
...
function PlayerActionRequest({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "par-cond",
    style: {
      borderColor: CONDITION_COLORS[c] || '#888'
    },
    onClick: () => sendCondition(c)
  }, /*#__PURE__*/React.createElement("span", {
    className: "par-cond-dot",
    style: {
      background: CONDITION_COLORS[c] || '#888'
    }
  }), c))) : showWeapon ? /*#__PURE__*/React.createElement("div", {
...
function TokenDetailPanel({
  ...
  return /*#__PURE__*/React.createElement(FloatPanel, {
    ...
    title: "Fly speed"
  }, " 🪽", mvFly) : null))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: 'var(--ink-dim)',
      marginBottom: 8
    ...
    className: "btn",
    onClick: () => applyHp(+1)
  }, "+ Heal"))), canEditConditions && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 10
    }
  ...
  })), isActiveMover && ownsThis && /*#__PURE__*/React.createElement("div", {
  ...
  }, "🪽 Fly"), mvJump > 0 && /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement("b", null, mvRemaining, " ft"), " remaining", mvMode === 'jump' ? ' · jump armed (next move)' : mvDashed ? ' · dashing' : mvMode === 'fly' ? ' · flying' : '')), !isDM && !isOwnPC && (() => {
...
function SettingsModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "settings-hint"
  }, "Disable if you find the motion distracting or experience motion sensitivity.")), /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
  ...
  }, "Roll your own dice - type in each result instead of auto-rolling")), /*#__PURE__*/React.createElement("div", {
    className: "settings-hint"
  }, "When on, attacks and saving throws let you enter the numbers you rolled at the table (the to-hit d20s, each damage die, and saves).")), /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
...
function weaponFromPreset(p) {
  return {
    ...
    attacks: [{
      ...
      toHit: 0,
      range: p.atk.range,
      damage: p.atk.dmg.map(([count, sides, modifier, type]) => ({
        count,
        sides,
        modifier,
        type
...
function NewCharacterBuilder({
  ...
  const Stepper = /*#__PURE__*/React.createElement("div", {
    className: "cc-steps"
  }, ['Class', 'Race', 'Stats', 'Health'].map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: s,
...
function AttackCinematic({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `acin-side ${isManeuver && pi >= 1 ? 'acin-clash-l' : ''}`
  }, /*#__PURE__*/React.createElement(Avatar, {
    ...
    className: `acin-swords ${isManeuver ? 'acin-man-glyph' : ''}`
  }, isManeuver ? '🤼' : '⚔'), isManeuver && /*#__PURE__*/React.createElement("div", {
    className: "acin-man-tag"
  }, "CONTEST"), (atk.weaponName || atk.attackName) && /*#__PURE__*/React.createElement("div", {
    ...
    className: `acin-side ${isManeuver && pi >= 1 ? 'acin-clash-r' : ''}`
  }, /*#__PURE__*/React.createElement(Avatar, {
    name: atk.targetName,
    ...
    onClick: () => onSetAdv?.(v)
  }, l))), hasToHit && pi >= 2 && /*#__PURE__*/React.createElement("div", {
    className: `acin-verdict ${hit ? 'hit' : 'miss'}`
  }, hit ? '✦ HIT ✦' : '✕ MISS'), hit && pi >= 3 && comps.length > 0 && /*#__PURE__*/React.createElement("div", {
  ...
  }, eff.save.ability, " save DC ", eff.save.dc)), !sr ? isDM ? /*#__PURE__*/React.createElement("div", {
  ...
  }, "✎ Enter ", eff.save.ability, " save") : /*#__PURE__*/React.createElement("button", {
    className: "btn sm primary",
    onClick: rollSave
  }, "🎲 Roll ", eff.save.ability, " save")) : /*#__PURE__*/React.createElement("div", {
    className: "acin-await"
  }, "Awaiting the save…") : /*#__PURE__*/React.createElement("div", {
    className: `acin-save-result ${sr.success ? 'pass' : 'fail'}`
  }, sr.ability, " save: ", sr.roll, sr.mod >= 0 ? ' + ' : ' - ', Math.abs(sr.mod), " = ", /*#__PURE__*/React.createElement("b", {
    key: sr.total,
    className: "acin-glow-num"
  }, sr.total), " vs DC ", eff.save.dc, /*#__PURE__*/React.createElement("span", {
    className: "acin-save-verdict"
  }, sr.success ? '✦ Resisted' : `✕ ${eff.condition}!`))) : /*#__PURE__*/React.createElement("div", {
    className: "acin-effect-title"
...
function AttackCinematicLayer({
  ...
  return ReactDOM.createPortal(/*#__PURE__*/React.createElement(AttackCinematic, {
    ...
    onSaveResult: isDM ? onSaveResult : null
  }), document.body);
}
function DMRequestsOverlay({
  ...
  return ReactDOM.createPortal(/*#__PURE__*/React.createElement(React.Fragment, null, otherReqs.length > 0 && /*#__PURE__*/React.createElement("div", {
